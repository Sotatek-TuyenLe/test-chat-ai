...
const Pricing = () => {
  const [selectedCycle, setSelectedCycle] = useState(12);
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      ...
      <header className="border-b border-slate-800 p-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="h-10 w-10 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-600 rounded-lg flex items-center justify-center">
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="mb-8">
          <h2 className="text-lg font-semibold mb-4">Chọn chu kỳ thanh toán</h2>
